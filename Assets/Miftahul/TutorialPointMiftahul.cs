...
public class CheckpointMiftahul : MonoBehaviour
{
    ...
    private PlayerControllerMiftahul playerController; // Reference to the player's controller script
    ...
    void Start()
    {
        ...
        if (player != null)
        {
            playerController = player.GetComponent<PlayerControllerMiftahul>();
        }
    }
